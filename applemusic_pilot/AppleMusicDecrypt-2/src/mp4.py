...
_GPAC = _TOOLS / "gpac" / "gpac.exe"
_MP4BOX = _TOOLS / "gpac" / "mp4box.exe"
_MP4EXTRACT = _TOOLS / "mp4extract.exe"
GPAC = str(_GPAC) if _GPAC.exists() else "gpac"
MP4BOX = str(_MP4BOX) if _MP4BOX.exists() else "MP4Box"
MP4EXTRACT = str(_MP4EXTRACT) if _MP4EXTRACT.exists() else "mp4extract"
